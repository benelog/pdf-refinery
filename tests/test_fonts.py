...
class TestFontResolver:
    ...
    def test_explicit_font_file_wins(self, tmp_path):
        resolver = FontResolver(font_file="/some/font.ttf")
        assert resolver.resolve("한글").file == "/some/font.ttf"
        assert resolver.resolve("Hello").file == "/some/font.ttf"
